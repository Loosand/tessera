...
const SHORTCUTS: readonly ShortcutDefinition[] = [
  ...
  },
  {
    id: "copy-block-range",
    category: "editor",
    label: "复制所选区块的 Markdown",
    description: "区块手柄选中一个或多个区块时复制 Markdown。",
    binding: "Mod+C",
    available: true,
  },
  {
    ...
    category: "editor",
    label: "剪切所选区块",
    description: "复制所选区块的 Markdown，并在写入剪贴板成功后删除区块。",
    binding: "Mod+X",
    available: true,
  },
  {
    id: "duplicate-block-range",
    category: "editor",
    label: "创建所选区块的副本",
    description: "在原位置后复制当前区块或连续区块范围。",
    binding: "Mod+D",
    available: true,
  },
  {
