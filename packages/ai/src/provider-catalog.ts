/**
 * [INPUT]: 首批 AI API 接入范围、供应商搜索词与用户维护的模型草稿
 * [OUTPUT]: AI SDK 供应商元数据、界面草稿类型与纯状态转换函数
...
export function createInitialAiProviderDrafts(): AiProviderDrafts {
...
export function appendAiProviderModel(
  ...
  return [...models, { id: normalizedId, enabled: true }]
}
